...
function RouteComponent() {
	...
	const handleSignUp = (e: React.SubmitEvent<HTMLFormElement>) => {
		...
		toast.promise<SignUpEmailResult>(
			signUpEmail({
				name,
				email,
				password,
			...
			}),
			{
				...
				error: data =>
					`${data.message ?? 'Ocorreu um erro ao tentar criar sua conta.'}`,
			}
		);
	};
		...
		<div className="mx-auto flex min-h-screen max-w-6xl flex-row items-center justify-between gap-16 px-8">
				...
				<div className="flex flex-col gap-2">
					<div className="flex flex-row items-center gap-3">
						...
						<div className="flex max-w-80 flex-col gap-1">
							<h3 className="text-xl font-semibold">Comece com clareza</h3>
							<p className="text-muted-foreground">
								Estruture sua operação de captação desde o primeiro acesso.
							</p>
						</div>
					</div>
					...
					<div className="flex flex-row items-center gap-3">
						...
						<div className="flex max-w-80 flex-col gap-1">
							<h3 className="text-xl font-semibold">Acompanhe cada etapa</h3>
							<p className="text-muted-foreground">
								Visualize projetos, propostas e oportunidades em um fluxo único.
							</p>
						</div>
					</div>
					...
					<div className="flex flex-row items-center gap-3">
						...
						<div className="flex max-w-80 flex-col gap-1">
							<h3 className="text-xl font-semibold">Conta protegida</h3>
							<p className="text-muted-foreground">
								Sua autenticação usa a mesma infraestrutura segura do login.
							</p>
						</div>
					</div>
				</div>
			...
			<Card className="w-full max-w-md shrink-0">
				<CardHeader className="flex flex-col items-center text-center">
					...
					<CardDescription>
						Informe seus dados para começar a usar.
					</CardDescription>
				</CardHeader>
						...
						<div className="flex flex-col gap-2">
							...
							<div className="relative">
								...
								<Button
									...
									{isPasswordConfirmationHidden && <Eye className="size-4" />}
									{!isPasswordConfirmationHidden && (
